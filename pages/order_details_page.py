...
class OrderPage:
    ...
    def click_second_button(self,browser):
        element = browser.find_element(*OrderLocators.ORDER_BUTTON_CENTER)
    ...
    def date_of_delivery(self, browser, data):
        browser.find_element(*OrderLocators.DATE_DELIVERY).send_keys(data,Keys.ENTER)
        return self
    ...
    def user_rent_order(self, browser,name,last_name,address,metro,number,delivery_date,rent_days,colour,comment):
